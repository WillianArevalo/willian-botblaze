    ...
    <section class="pt-16 ml-0 lg:ml-64 ">
        <div class="h-full p-4 text-white sm:p-8">
            <div class="flex items-center gap-2 justify-left">
                <h1 class="font-bold uppercase text-1xl text-violet-600 sm:text-3xl">Movimientos</h1>
            </div>
            <div class="mt-4">
                <div class="flex flex-col items-start justify-between gap-4 mb-5 sm:flex-row sm:items-center">
                    <h6 class="text-base text-gray-400">Lista de movimientos</h6>
                    <div class="flex items-center gap-2">
                        <a href="{{ route('movements.input') }}"
                            class="flex items-center justify-center gap-2 px-4 py-3 text-base text-green-500 bg-green-700 rounded hover:bg-opacity-20 bg-opacity-10">
                            <x:svg-icon icon="input" class="w-5 h-5 text-current" />
                            Registrar entrada
                        </a>
                        <a href="{{ route('movements.output') }}"
                            class="flex items-center justify-center gap-2 px-4 py-3 text-base text-red-500 bg-red-700 rounded hover:bg-opacity-20 bg-opacity-10">
